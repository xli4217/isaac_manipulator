...
- [View page source](https://nvidia-isaac-ros.github.io/_sources/reference_workflows/isaac_perceptor/reference_architecture.rst.txt)

* * *

# NVIDIA Isaac Perceptor Reference Architecture [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#nvidia-isaac-perceptor-reference-architecture "Link to this heading")
...
## What is NVIDIA Isaac Perceptor? [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#what-is-nvidia-isaac-perceptor "Link to this heading")
...
## What is this document? [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#what-is-this-document "Link to this heading")
...
## Who is this document for? [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#who-is-this-document-for "Link to this heading")
...
## Reference Architecture [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#reference-architecture "Link to this heading")
...
![https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_main.png/](https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_main.png/)
...
## Components [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#components "Link to this heading")
...
### Visual Input [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#visual-input "Link to this heading")

![https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_component1.png/](https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_component1.png/)
...
>
> - [Nova Orin Developer Kit](https://nvidia-isaac-ros.github.io/robots/nova_developer_kit/index.html)
>
...
> For example, [Run Isaac ROS Nvblox with a rosbag](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_nvblox/isaac_ros_nvblox/index.html).
...
> For example, [Run Isaac ROS NvBlox with Isaac Sim](https://nvidia-isaac-ros.github.io/concepts/scene_reconstruction/nvblox/tutorials/tutorial_isaac_sim.html).


**Variations:**

#### Use Alternate RGB Cameras [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#use-alternate-rgb-cameras "Link to this heading")
...
For more information, see [Isaac ROS ESS API Documentation](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_dnn_stereo_depth/isaac_ros_ess/index.html).

#### Use Zed X [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#use-zed-x "Link to this heading")

Contact [Stereolabs](https://www.stereolabs.com/) for their integration of Zed X Camera with Isaac Perceptor.

#### Use RGBD Cameras [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#use-rgbd-cameras "Link to this heading")
...
![https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_variation2.png/](https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_variation2.png/)
...
> For more information, see [RealSense](https://www.intel.com/content/www/us/en/architecture-and-technology/realsense-overview.html) camera and [List of supported Realsense cameras](https://nvidia-isaac-ros.github.io/getting_started/hardware_setup/sensors/realsense_setup.html).
>
> For example, Tutorial: [Running with a RealSense camera](https://nvidia-isaac-ros.github.io/concepts/scene_reconstruction/nvblox/tutorials/tutorial_realsense.html) (live or from recorded data).
...
> - Read more in the [Orbbec PR](https://www.orbbec.com/news/orbbec-gemini-330-series-stereo-vision-cameras-integrated-with-nvidia-isaac-robotics-platform/). For more information about this integration, reach out to Orbbec or [contact NVIDIA](https://developer.nvidia.com/isaac-platform-contact-us-form) for details, also see:
>
>
> > - [Orbbec technical documentation](https://github.com/orbbec)
> >
> > - [Orbbec Firmware releases](https://www.orbbec.com/docs/g330-firmware-release/)
> >
> > - [Gemini 335L product page](https://www.orbbec.com/products/stereo-vision-camera/gemini-335l/)
> >
> > - [Orbbec Gemini 330 series documentation](https://www.orbbec.com/docs/orbbec-gemini-330-series-documentation/)
...
> - Read more in the [LIPS PR](https://www.lips-hci.com/post/lipsedge-camera-with-nvidia-isaac-perceptor-computex-2024). For more information about this integration, reach out to LIPS or [contact NVIDIA](https://developer.nvidia.com/isaac-platform-contact-us-form) for details.


### Visual Odometry [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#visual-odometry "Link to this heading")

![https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_component2.png/](https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_component2.png/)
...
For more information, see [cuVSLAM](https://nvidia-isaac-ros.github.io/concepts/visual_slam/cuvslam/index.html) (CUDA Accelerated VSLAM Library).

**Variations:**

#### Use a Different Odometry Source and Localization Method [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#use-a-different-odometry-source-and-localization-method "Link to this heading")
...
- AMCL: When a static map of the robot’s environment is available, cuVSLAM can be replaced with AMCL, which uses the static map for localizing the robot. For detailed guidance, [Run Isaac ROS NvBlox with Isaac Sim](https://nvidia-isaac-ros.github.io/concepts/scene_reconstruction/nvblox/tutorials/tutorial_isaac_sim.html) [Autonomous Navigation with Isaac Perceptor and Nav2](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/tutorials_on_carter/demo_navigation.html). The tutorial includes steps on creating a map of your environment using lidar on the robot.


> ![https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_visual_odometry_AMCL.png/](https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_visual_odometry_AMCL.png/)

- Wheel Odometry and IMU with AMCL: cuVSLAM for odometry can be substituted with wheel odometry and IMU data. Localization information would be derived from the sensors on the robot’s wheel motors and IMU. Initially, AMCL would be required to create a static map of the environment if one is not already available. Additionally, AMCL is essential for correcting odometry drift. This variation employs AMCL for global localization and wheel odometry for local positioning. For example, [Visual SLAM using a RealSense camera with integrated IMU](https://nvidia-isaac-ros.github.io/concepts/visual_slam/cuvslam/tutorial_realsense.html).


> ![https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_visual_odometry_wheelOdometry.png/](https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_visual_odometry_wheelOdometry.png/)
...
For more information, see [Isaac ROS Correlated Timestamp Driver](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_nova/isaac_ros_correlated_timestamp_driver/index.html).

### Semantic Segmentation [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#semantic-segmentation "Link to this heading")

![https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_component3.png/](https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_component3.png/)
...
### Voxel Grid Mapping [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#voxel-grid-mapping "Link to this heading")

![https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_component4.png/](https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_component4.png/)
...
In the featured architecture, this component is implemented using Nvblox. Nvblox processes RGB images, depth images, segmentation masks, and camera poses produced by the other components to generate one or more occupancy masks, with optional colors for visualization. The costmap produced is utilized by the Navigation component (5) to identify safe areas for the robot to travel, while the RGB colors may be used for Visualization (6). For more information, see [Nvblox](https://nvidia-isaac-ros.github.io/concepts/scene_reconstruction/nvblox/index.html).

### Planning and Navigation [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#planning-and-navigation "Link to this heading")
...
Nav2 is an open-source navigation system that provides tools to add autonomous functionality to mobile robots. It includes a planner that computes a path to the goal position using global and local costmaps generated by Nvblox. For more information, see [Nav2](https://nav2.org/).

### Visualization [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#visualization "Link to this heading")

![https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_component6.png/](https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_component6.png/)
...
For more information, see [Foxglove](https://foxglove.dev/).

### Hardware Platforms [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#hardware-platforms "Link to this heading")
...
| Nova Orin Developer Kit (includes Jetson AGX Orin) | Nova Carter (includes Jetson AGX Orin) |
| --- | --- |
| ![https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_component7_nova_orin_devkit.png/](https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_component7_nova_orin_devkit.png/) | ![https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_component7_nova_carter_devkit.png/](https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_component7_nova_carter_devkit.png/) |

For more information, see:

> - [Nova Orin Developer Kit](https://nvidia-isaac-ros.github.io/robots/nova_developer_kit/index.html)
>
> - [Nova Carter](https://nvidia-isaac-ros.github.io/robots/nova_carter/index.html) Reference Robot

For example:

> - Tutorial: [Isaac Perceptor with the Nova Orin Developer Kit](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/run_perceptor_on_devkit.html)
>
> - Tutorial: [Isaac Perceptor with Nova Carter](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/run_perceptor_on_carter.html)

**Variations:**

#### Use Additional Devices for Specific Tasks [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#use-additional-devices-for-specific-tasks "Link to this heading")
...
![https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_hardware_platform.png/](https://media.githubusercontent.com/media/NVIDIA-ISAAC-ROS/.github/main/resources/isaac_ros_docs/reference_workflows/isaac_perceptor/perceptor_RA_hardware_platform.png/)
...
NVIDIA provides a sample config for the Carter robot using Cyclone DDS below. If you are using a Carter robot, add this profile to carter-dev/docker/middleware\_profiles:
...
Add the following line to _carter-dev/docker/Dockerfile.carter\_dev_:
...
For more information, see [ROS Domain ID](https://docs.ros.org/en/foxy/Concepts/About-Domain-ID.html).
...
## Additional Resources [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html\#additional-resources "Link to this heading")
...
> - [cuVSLAM](https://nvidia-isaac-ros.github.io/concepts/visual_slam/cuvslam/index.html) (CUDA Stereo Visual SLAM)
>
...
Releases[release-3.2](https://nvidia-isaac-ros.github.io/v/release-3.2/reference_workflows/isaac_perceptor/reference_architecture.html)[latest](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/reference_architecture.html)[release-2.1](https://nvidia-isaac-ros.github.io/v/release-2.1/index.html)[release-3.1](https://nvidia-isaac-ros.github.io/v/release-3.1/index.html)