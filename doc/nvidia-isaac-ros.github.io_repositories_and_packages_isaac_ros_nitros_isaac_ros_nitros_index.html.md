...
- `isaac_ros_nitros`
- [View page source](https://nvidia-isaac-ros.github.io/_sources/repositories_and_packages/isaac_ros_nitros/isaac_ros_nitros/index.rst.txt)

* * *

# `isaac_ros_nitros` [](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_nitros/isaac_ros_nitros/index.html\#package-name "Link to this heading")

Source code on [GitHub](https://github.com/NVIDIA-ISAAC-ROS/isaac_ros_nitros/blob/main/isaac_ros_nitros).

## Quickstart [](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_nitros/isaac_ros_nitros/index.html\#quickstart "Link to this heading")

### Creating Graphs with NITROS-Accelerated Nodes [](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_nitros/isaac_ros_nitros/index.html\#creating-graphs-with-nitros-accelerated-nodes "Link to this heading")

Besides the fully tested [graphs](https://nvidia-isaac-ros.github.io/concepts/nitros/index.html#nitros-accelerated-graphs),
...
[guide](https://docs.ros.org/en/humble/How-To-Guides/Launching-composable-nodes.html).
...
### Using NITROS-Accelerated Nodes in Existing Non-NITROS Graphs [](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_nitros/isaac_ros_nitros/index.html\#using-nitros-accelerated-nodes-in-existing-non-nitros-graphs "Link to this heading")
...
1. Follow the same steps introduced in the [previous section](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_nitros/isaac_ros_nitros/index.html#creating-graphs-with-nitros-accelerated-nodes) to create
...
- [NITROS-accelerated AprilTag node + non-NITROS USB camera node](https://nvidia-isaac-ros.github.io/concepts/fiducials/apriltag/tutorial_usb_cam.html)


Note

NITROS nodes enable [CUDA memory pool](https://docs.nvidia.com/cuda/cuda-runtime-api/group__CUDART__MEMORY__POOLS.html) by default. To disable it, set the
environment variable `DISABLE_NITROS_CUDA_MEM_POOL` parameter to `true`.

### Enabling diagnostics for NITROS Nodes [](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_nitros/isaac_ros_nitros/index.html\#enabling-diagnostics-for-nitros-nodes "Link to this heading")
...
Therefore, they are compatible with [ros2 diagnostics](https://github.com/ros/diagnostics).
...
Releases[release-3.2](https://nvidia-isaac-ros.github.io/v/release-3.2/repositories_and_packages/isaac_ros_nitros/isaac_ros_nitros/index.html)[latest](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_nitros/isaac_ros_nitros/index.html)[release-2.1](https://nvidia-isaac-ros.github.io/v/release-2.1/repositories_and_packages/isaac_ros_nitros/isaac_ros_nitros/index.html)[release-3.1](https://nvidia-isaac-ros.github.io/v/release-3.1/repositories_and_packages/isaac_ros_nitros/isaac_ros_nitros/index.html)