...
- [View page source](https://nvidia-isaac-ros.github.io/_sources/reference_workflows/isaac_perceptor/tutorials_on_devkit/demo_navigation.rst.txt)

* * *

# Tutorial: Integrating Isaac Perceptor with Nav2 on a robot with the Nova Orin Developer Kit [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/tutorials_on_devkit/demo_navigation.html\#tutorial-integrating-isaac-perceptor-with-nav2-on-a-robot-with-the-nova-orin-developer-kit "Link to this heading")

This will guide you through the most important steps to using the Nova Orin Developer Kit with
[Nav2](https://nav2.org/) on your own robot.

## Benefits of integrating Isaac Perceptor with a Navigation Stack [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/tutorials_on_devkit/demo_navigation.html\#benefits-of-integrating-isaac-perceptor-with-a-navigation-stack "Link to this heading")
...
## Prerequisites [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/tutorials_on_devkit/demo_navigation.html\#prerequisites "Link to this heading")

For this tutorial, you must have completed the
[Tutorial: Running Camera-based 3D Perception with Isaac Perceptor](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/tutorials_on_devkit/demo_perceptor.html)
It is also assumed that you are familiar with [Nav2](https://nav2.org/) and that you are able to use it for
...
[extrinsic calibration](https://nvidia-isaac-ros.github.io/getting_started/hardware_setup/sensors/amr_extrinsic_calibration.html).

## Instructions [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/tutorials_on_devkit/demo_navigation.html\#instructions "Link to this heading")
...
2. Add Isaac Perceptor to your existing [Nav2](https://nav2.org/) launch file by
including the
[perceptor.launch.py of the nova\_developer\_kit\_bringup package](https://github.com/NVIDIA-ISAAC-ROS/nova_developer_kit/blob/main/nova_developer_kit_bringup/launch/perceptor.launch.py).
...
Additionally then also include the new nvblox\_layer in the `plugins` parameter of the
...
## Integration Reference Example [](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/tutorials_on_devkit/demo_navigation.html\#integration-reference-example "Link to this heading")

For a complete example of how to integrate Isaac Perceptor with Nav2 we
recommend taking a look at the
[navigation launch file](https://github.com/NVIDIA-ISAAC-ROS/nova_carter/blob/main/nova_carter_bringup/launch/navigation.launch.py)
...
Releases[release-3.2](https://nvidia-isaac-ros.github.io/v/release-3.2/reference_workflows/isaac_perceptor/tutorials_on_devkit/demo_navigation.html)[latest](https://nvidia-isaac-ros.github.io/reference_workflows/isaac_perceptor/tutorials_on_devkit/demo_navigation.html)[release-2.1](https://nvidia-isaac-ros.github.io/v/release-2.1/index.html)[release-3.1](https://nvidia-isaac-ros.github.io/v/release-3.1/reference_workflows/isaac_perceptor/tutorials_on_devkit/demo_navigation.html)